...
》قفل کردن لینک
》بازکردن لینک
در صورت قفل اگر ممبرها لینکی ارسال کنند لینک حذف خواهدشد.

》قفل کردن استیکر
》بازکردن استیکر
درصورت قفل ارسال استیکر ممنوع میشود.

》قفل کردن شکلک
》بازکردن شکلک
درصورت قفل ارسال شکلک ممنوع میشود.

》قفل کردن عربی
》بازکردن عربی
درصورت قفل چت عربی ممنوع میشود.

》قفل کردن انگلیسی
》بازکردن انگلیسی
درصورت قفل چت انگلیسی ممنوع میشود.

》قفل کردن مخاطب ها
》بازکردن مخاطب ها
درصورت قفل ارسال مخاطب (شرکردن شماره)ممنوع میشود.

》قفل کردن اسپم
》بازکردن اسپم
درصورت قفل کاربران با دادن اسپم(هرزنامه)از گروه حذف خواهند شد.

》قفل کردن راست به چپ
》بازکردن راست به چپ
درصورت قفل نوشتن راست به چپ ممنوع میشود.

》قفل کردن ورودوخروج
》بازکردن ورودوخروج
درصورت قفل ورود و خروج اعضا نمایش داده نمیشود.

》قفل کردن سختگیرانه
》بازکردن سختگیرانه
درصورت قفل اگر کاربری خلاف قوانین عمل کند از گروه حذف میشود.(مثلا اگرلینک قفل باشد کاربر با دادن لینک از گروه حذف میشود)

》قفل کردن ورود
》بازکردن ورود
درصورت قفل ورود به گروه ممنوع میشود.(با ورود از گروه حذف میشود)

》قفل کردن خروج
》بازکردن خروج
درصورت قفل خروج از گروه ممنوع میشود.(با خروج از گروه بن میشود)

》قفل کردن ممبر
》بازکردن ممبر
درصورت قفل ورود و خروج به گروه ممنوع میشود.(درصورت ورود از گروه حذف و درصورت خروج بن میشود)

》قفل کردن فلود
》بازکردن فلود
درصورت قفل دادن پی ام پشت سرهم و تکراری در گروه ممنوع میشود.

》قفل کردن ربات ها
》بازکردن ربات ها
درصورت قفل اد کردن ربات در گروه ممنوع میشود.

》قفل کردن فحش
》بازکردن فحش
درصورت قفل فحاشی در گروه ممنوع میشود.

》قفل کردن فوروارد
》بازکردن فوروارد
درصورت قفل فوروارد کردن در گروه ممنوع میشود.

》قفل کردن اپراتور
》بازکردن اپراتور
درصورت قفل تبلیغ شارژ ممنوع میشود.

》قفل کردن تگ
》بازکردن تگ
درصورت قفل ارسال تگ(#) در گروه ممنوع میشود.

》قفل کردن دستورات
》بازکردن دستورات
ممنوع کردن استفاده دستورات برای کاربران
 
 قفل 》ممنوعیت
》قفل کردن چت
》بازکردن چت
...
#info
نمایش اطلاعات کلی در مورد سوپر گروه
#setlang (fa,en)
تعیین زبان گروه(fa=فارسی-en=انگلیسی)
#who
لیست کاربران گروه
#me
اطلاعاتی در باره شما در گروه
#kmember
حذف کاربر با فرستادن پیامی از او 
#admins
لیست مدیران گروه
#modlist
لیست مدیران ربات
#kick @username
اخراج کاربر از گروه با آیدی یا ریپلی
#invite @username
دعوت کاربر به گروه
#ban @username
بن کردن کاربر با آیدی یا ریپلی
#unban
خارج کردن کاربر از بن لیست با آیدی یا ریپلی
#id
نمایش آیدی شما و آیدی سوپر گروه
#id from
...
صامت کردن همه صداها گیف ها عکس ویدیو سرویس
#muteall Xh Ym Zs
صامت کردن همه کاربران تا زمانی مشخص
مانند:!muteall 2h 12m 56s
#unmute [all|audio|gifs|photo|video|service]
خارج کردن از صامت
#setflood [value]
تنظیم حساسیت اسپم(جای [value] عددی بین 1-20قراردهید)
#settings
تنظیمات گروه
#silent @username
ساکت کردن کاربری با آیدی یا ریپلی
#unsilent @username
خارج کردن کاربر از لیست صامت با آیدی یا ریپلی
#silentlist
لیست افراد صامت شده
#mutelist
لیست افراد صامت
...
پاک کردن قوانین اطلاعات لیست مدیران لیست کاربران صامت لیست کلمات فیلتر
#clean msg [value]
حذف پیام های اخیر گروه (جای value عددی بین 1-200)
...
جدیدترین اخبار
#weather city
هوا شناسی(بجای city نام شهر مورد نظر را بنویسید)
#time
زمان بصورت استیکر
#time city
زمان شهر دلخواه بصورت استیکر
#time&date
زمان و تاریخ
#azan city
زمان تمامی اذان های یک شهر(جای city نام شهر مورد نظر رابه انگلیسی بنویسید)
#tren text
ترجمه فارسی به انگلیسی
#trfa text
ترجمه انگلیسی به فارسی
...
کلمه یا اسم شما بصورت عکس
#earz (money)
مقدار ارز بازار(جای پول مقدار عددی پول را بنویسید)

بجای text کلمه مورد نظر خود را بنویسید.
]]
local permagbot6 = [[
لیست دستورات قفلی سوپر گروه:
#lock text 
#unlock text
1)links
2)flood
